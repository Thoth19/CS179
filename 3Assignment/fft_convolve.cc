...
#define STOP_RECORD_TIMER(name) {                           \
    ...
    for (int ch = 0; ch < nChannels; ch++){
        ...
        // We want to pad with 0s, so set 0s, then copy the rest in.
        // We could do it in the other order, but the speed up is negligible
        ...
        */
        ...
        // Did this above because it makes the code cleaner to think about.
        ...
        */
        ...
        /* Run the inverse DFT on the output signal. in-place */
